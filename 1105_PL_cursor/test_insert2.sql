...
-- 연봉이 5000이상이면 CP_EMP2테이블에 
-- 추가하고 5000이하라면 CP_EMP2에 추가하는 pl/sql 작성
-- cp_emp3테이블에 추가되는 사원의 부서번호는 무조건 10번으로 추가하세요.
...
begin
	...
	if sal >5000 then
	   ...
	   dbms_output.put_line ('연봉이 5000이상이므로 cp_emp3 테이블에 추가하였습니다.');
	   ...
	   dbms_output.put_line ('연봉이 5000이상이므로 cp_emp2 테이블에 추가하였습니다.');
