...
insert into lunch_admin(ID,PASS,NAME)
values('lunch','1234','류이호');
insert into lunch_admin(ID,PASS,NAME)
values('root','1234','루랑이');
commit;
...
insert into lunch(LUNCH_CODE,LUNCH_NAME,IMG,PRICE,SPEC,ID)
values(lunch_code,'돈까스','m1_l2.gif',3800,'바삭튀겨낸 튀김옷안에 숨겨진 고기를 한입 베어물면
오지마을 이장님도  울고갈 감동실화인 부분 인지용. 소스맛도 끝내줍니다','admin');
...
values(order_code,1,'김정윤','010-3456-4567','211.63.89.132','L_000001');

insert into ordering (ORDER_NUM, QUAN, ORDER_NAME, PHONE, IP_ADDRESS, LUNCH_CODE)
values(order_code,3,'공선의','010-5436-2455','211.63.89.157','L_000001');

insert into ordering (ORDER_NUM, QUAN, ORDER_NAME, PHONE, IP_ADDRESS, LUNCH_CODE)
values(order_code,1,'이재현','010-5646-8786','211.63.89.135','L_000002');
