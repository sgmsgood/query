...
CREATE TABLE admin (
	...
	name VARCHAR2(30) NOT NULL, /* 비밀번호 */
	password VARCHAR2(30) NOT NULL, /* 이름 */
...
CREATE TABLE movie (
	...
	playdate VARCHAR2(8) NOT NULL, /* 개봉일 */
	synopsis VARCHAR2(700) NOT NULL, /* 줄거리 */
...
CREATE TABLE snack (
	...
	snack_date DATE NOT NULL /* 스낵추가일 */
);
...
CREATE TABLE on_screen (
	screen_num CHAR(12) NOT NULL, /* 상영번호 */
	screen_date VARCHAR2(8) NOT NULL, /* 상영날짜 */
